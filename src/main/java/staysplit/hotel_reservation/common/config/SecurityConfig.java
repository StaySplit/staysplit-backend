    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        return httpSecurity
                ...
                .authorizeHttpRequests(req -> req
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/hotels","/api/hotels/*", "/api/rooms/*").hasRole("PROVIDER")
                        .requestMatchers(HttpMethod.PUT, "/api/hotels","/api/hotels/*", "/api/rooms/*").hasRole("PROVIDER")
                        .requestMatchers(HttpMethod.DELETE, "/api/hotels","/api/hotels/*", "/api/rooms/*").hasRole("PROVIDER")
